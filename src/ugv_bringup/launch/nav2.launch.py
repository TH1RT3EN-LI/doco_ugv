...
def generate_launch_description():
    ...
    collision_monitor_params_file = os.path.join(bringup_share, "config", "collision_monitor.yaml")
    ...
    def create_nav2_launch(cmd_vel_topic, condition=None):
        return GroupAction(
            actions=[
    ...
    nav2_launch = create_nav2_launch("/ugv/cmd_vel_nav_raw", IfCondition(enable_collision_monitor))
    nav2_launch_direct = create_nav2_launch("/ugv/cmd_vel_nav", UnlessCondition(enable_collision_monitor))
    ...
    collision_monitor_node = Node(
        ...
        output="screen",
        parameters=[collision_monitor_params_file, {"use_sim_time": use_sim_time_param}],
